...
<head>
    ...
    <!-- Colors -->
    <link rel="stylesheet" type="text/css" href="landing/assets/css/colors/color1.css" id="colors">

    <!-- Favicon and Touch Icons  -->
    <link rel="shortcut icon" href="/landing/assets/icon/favicon.png">
    <link rel="apple-touch-icon-precomposed" href="landing/assets/icon/apple-touch-icon-158-precomposed.png">
...
<body class="header-fixed page no-sidebar header-style-2 topbar-style-2 menu-has-search">
                    ...
                    <div id="top-bar-inner" class="container">
                        <div class="top-bar-inner-wrap">
                            <div class="top-bar-content">
                                <div class="inner">
                                    <span class="address content">Tahasis Bin Mahjoub, Zaghaya Mila Road</span>
                                    <span class="phone content">031429074</span>
                                    <span class="time content">Sun-Fri: 8am - 4pm</span>
                                </div>
                            </div><!-- /.top-bar-content -->
                            ...
                            <div class="top-bar-socials">
                                <div class="inner">
                                    ...
                                    <span class="icons">
                                        <a href="https://www.facebook.com/DIRECTIONCOMMERCEMILA/"><i
                                    ...
                                    <div id="rev-slider1" class="rev_slider fullwidthabanner">
                                        <ul>
                                            ...
                                            <li data-transition="random">
                                                <!-- Main Image -->
                                                <img src="landing/assets/img/slider/slider-bg-2.jpg" alt=""
                                    ...
                                    <div class="container-fluid">
                                        <div class="row equalize sm-equalize-auto">
                                            <div class="col-md-6 half-background style-1">
                                                <img class="w-100" src="landing/assets/img/slider/slider-bg-2.jpg">
                                            ...
                                            <div class="col-md-6 bg-light-grey">
                                                ...
                                                <div class="themesflat-content-box clearfix"
                                                    data-margin="0 25% 0 4.5%" data-mobilemargin="0 0 0 4.5%">
                                                    <div class="themesflat-headings style-1 clearfix">
                                                        <h2 class="heading">WELCOME TO DIRECTORATE OF COMMERCE</h2>
                                                        <div
                                                            class="sep has-width w100 accent-bg margin-top-11 clearfix">
                                                        </div>
                                                        {{-- DESCRIPTION HERE --}}
                                                        <p class="sub-heading margin-top-0">The Directorate of
                                                            Commerce is a public administration of a local nature that
                                                            is affiliated nationally and functionally to the Ministry of
                                                            Commerce and is called the Foreign Departments, in
                                                            accordance with Executive Decree No. 409-03 dated
                                                            11/05/2003, whose tasks include implementing the established
                                                            national policy in the fields of foreign trade, competition,
                                                            quality, and organizing activities.</p>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="themesflat-spacer clearfix" data-desktop="39"
                                                    data-mobile="35" data-smobile="35"></div>
                                                <div class="themesflat-carousel-box data-effect clearfix"
                ...
                <div id="bottom-bar-inner" class="container">
                    <div class="bottom-bar-inner-wrap">
                        <div class="bottom-bar-content">
                            <div id="copyright">© <span class="text">All Rights Reserved 2023</span>
                            </div>
    ...
    <script src="landing/assets/js/tether.min.js"></script>
    <script src="landing/assets/js/bootstrap.min.js"></script>
    <script src="landing/assets/js/animsition.js"></script>
    <script src="landing/assets/js/owl.carousel.min.js"></script>
    <script src="landing/assets/js/countto.js"></script>
    <script src="landing/assets/js/equalize.min.js"></script>
    <script src="landing/assets/js/jquery.isotope.min.js"></script>
    <script src="landing/assets/js/owl.carousel2.thumbs.js"></script>

    <script src="landing/assets/js/jquery.cookie.js"></script>
    <script src="landing/assets/js/gmap3.min.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAIEU6OT3xqCksCetQeNLIPps6-AYrhq-s&region=GB"></script>
    <script src="landing/assets/js/shortcodes.js"></script>
    <script src="landing/assets/js/main.js"></script>

    <!-- Revolution Slider -->
    <script src="landing/includes/rev-slider/js/jquery.themepunch.tools.min.js"></script>
    <script src="landing/includes/rev-slider/js/jquery.themepunch.revolution.min.js"></script>
    <script src="landing/assets/js/rev-slider.js"></script>
    <!-- Load Extensions only on Local File Systems ! The following part can be removed on Server for On Demand Loading -->
    <script src="landing/includes/rev-slider/js/extensions/revolution.extension.actions.min.js"></script>
    <script src="landing/includes/rev-slider/js/extensions/revolution.extension.carousel.min.js"></script>
    <script src="landing/includes/rev-slider/js/extensions/revolution.extension.kenburn.min.js"></script>
    <script src="landing/includes/rev-slider/js/extensions/revolution.extension.layeranimation.min.js"></script>
    <script src="landing/includes/rev-slider/js/extensions/revolution.extension.migration.min.js"></script>
    <script src="landing/includes/rev-slider/js/extensions/revolution.extension.navigation.min.js"></script>
    <script src="landing/includes/rev-slider/js/extensions/revolution.extension.parallax.min.js"></script>
    <script src="landing/includes/rev-slider/js/extensions/revolution.extension.slideanims.min.js"></script>
    <script src="landing/includes/rev-slider/js/extensions/revolution.extension.video.min.js"></script>
